...
import { FileText, Briefcase, Video, ArrowRight } from 'lucide-react';
    ...
    const tools = [
        {
            ...
            desc: "Get instant AI feedback on your resume and generative suggestions.",
            icon: <FileText className="w-8 h-8 text-emerald-200" />,
            path: "/candidate/resume",
            color: "bg-emerald-500/20"
        },
        {
            title: "Job Match",
            desc: "See which jobs you are most likely to land based on your skills.",
            icon: <Briefcase className="w-8 h-8 text-amber-200" />,
            path: "/candidate/jobs",
            color: "bg-amber-500/20"
        },
        {
            title: "Interview Prep",
            desc: "Practice with our AI interviewer that mimics real-world scenarios.",
