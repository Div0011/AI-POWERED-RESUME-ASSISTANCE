        ...
        <div className="w-full max-w-4xl mx-auto space-y-6 sm:space-y-8 pb-32 p-4 sm:p-0 pt-24 sm:pt-32">
            ...
            >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <div className="space-y-2">
                        ...
                        <input type="text" placeholder="Enter full name" className="w-full bg-black/40 border border-white/5 rounded-xl px-4 py-3.5 text-sm focus:border-[var(--primary)] outline-none transition-colors" />
                    </div>
                    <div className="space-y-2">
            ...
            >
                ...
                <div className="space-y-4">
                    {[
                        { label: 'Application Updates', desc: 'Alert when mission status changes' },
                        { label: 'Secure Messages', desc: 'Direct protocol communications' },
                        { label: 'Marketing Comms', desc: 'General sector intelligence' }
                    ].map((item, i) => (
                        <div key={i} className="flex items-center justify-between p-4 sm:p-6 bg-black/20 rounded-2xl border border-white/5 group hover:border-amber-500/20 transition-all">
                            ...
                            <div className="w-10 sm:w-12 h-6 sm:h-7 bg-amber-500/20 rounded-full flex items-center px-1 border border-amber-500/20">
                                <div className="w-4 sm:w-5 h-4 sm:h-5 bg-amber-500 rounded-full shadow-[0_0_10px_rgba(245,158,11,0.5)]" />
                            </div>
                        </div>
                    ))}
                </div>
